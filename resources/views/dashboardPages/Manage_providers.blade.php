...
<td>
        ...
        @if(isset($provider->info->image) && !empty($provider->info->image))
                                         <a href="service-details.html">
                      <img src="{{asset('uploads/photo/'.$provider->info->image)}}"
                         ...
                         <img src="https://static1.squarespace.com/static/54b7b93ce4b0a3e130d5d232/54e20ebce4b014cdbc3fd71b/5a992947e2c48320418ae5e0/1519987239570/icon.png?format=1500w"
                                     ...
                                     @endif
                                            ...
                                            <td>
                                                <a href={{'Manage_providers/delete/'.$provider->id}} class="btn bg-danger-light ml-1">
