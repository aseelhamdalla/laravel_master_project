    ...
    <div class="container">
        ...
        <img alt="profile image" src="{{asset('uploads/photo/'.Auth::user()->info->image)}}" class="avatar-lg rounded-circle">
                ...
                <div class="widget settings-menu">
                    <ul>
                        <li class="nav-item">
                            <a href="/user/dashboard/{{Auth::user()->id}}" class="nav-link active">
                ...
                <div class="row">
                	...
                	<div class="col-lg-4">
                        <a href="" class="dash-widget dash-bg-2">
                            <span class="dash-widget-icon">{{$reviewsCount}}</span>
                            <div class="dash-widget-info">
                                <span>Reviews</span>
                            </div>
                        </a>
                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-8">
                            <div class="card-body">
                                ...
                                <ul class="row">
                                    <li class="col-sm-6">
                                        <p>Paid at {{$lastBookingDate}}</p>
                                    </li>
                                    <li class="col-sm-6">
                                        <p><span class="text-success">Paid</span>  <span class="amount">{{$lastBooking}}</span>
                                        </p>
                                    </li>
                                </ul>
                            </div>
