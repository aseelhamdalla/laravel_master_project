...
@section('section1')
        ...
        <form action="/book/{{Auth::user()->id}}" method="post" enctype="multipart/form-data"  >
							@csrf
							<div class="row">
								<div class="col-lg-6">
...
@endforeach
				...
				<div style="color:red; margin:15px  0 15px 0">{{$errors->first('avalability_id')}}</div>
...
@endforeach
				...
				<div style="color:red; margin:15px  0 15px 0">{{$errors->first('notes')}}</div>
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<input type="hidden" class="form-control"  name="is_taken"  value="yes"   type="text"  autocomplete="off" >
